...
- [更新方針と更新履歴](https://itdojp.github.io/ai-era-engineers-mind-book/appendices/update-notes/) - 変動情報の確認日、正本、適用範囲、陳腐化の兆候、内容上の更新履歴
...
この書籍は GitHub Pages / Jekyll で公開されています。リポジトリ内の `docs/` が公開サイトのソースです。
