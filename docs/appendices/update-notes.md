...
- 付録Cを推奨読書リストとして現代化し、古典的な書籍を残しつつ、NIST AI RMF、NIST GenAI Profile、ISO/IEC 42001、OWASP LLM Top 10、MITRE ATLAS、MCP、OpenAI Evals、GitHub Copilot、Google SRE、Diátaxis、シリーズ内関連書籍、役割別おすすめ順へ再編した（2026-05-24）。
