...
未確認の項目は「前提（Assumption）」として切り出し、確認タスクとセットで管理する（[付録A：思考ツールテンプレート集](../../appendices/templates.md) の「前提・未確定事項ログ」参照）。
...
要件定義でAIを使うときは、[AI協働の標準手順（SOP）](../../introduction/ai-collaboration-sop/) を「要件を成果物に反映し、記録する」まで通すことが重要である。特に「AIから良さそうな要件案が出た」時点で止めず、次の対応関係を意識して進める。
